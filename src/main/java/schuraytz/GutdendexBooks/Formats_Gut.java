...
public class Formats_Gut {
    ...
    @SerializedName("application/prs.tei")
    @Expose
    ...
    public String getApplicationPrsTei() {
        return applicationPrsTei;
    }

    public void setApplicationPrsTei(String applicationPrsTei) {
        this.applicationPrsTei = applicationPrsTei;
    }
