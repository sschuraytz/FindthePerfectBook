...
public class Book_NY {
    ...
    @Expose
    private List<Isbn_NY> isbns = null;
    @SerializedName("buy_links")
    @Expose
    private List<BuyLink_NY> buyLinks = null;
    ...
    public List<Isbn_NY> getIsbns() {
        return isbns;
    }

    public void setIsbns(List<Isbn_NY> isbns) {
        this.isbns = isbns;
    }

    public List<BuyLink_NY> getBuyLinks() {
        return buyLinks;
    }

    public void setBuyLinks(List<BuyLink_NY> buyLinks) {
